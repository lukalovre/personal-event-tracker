...
public record DiretorGridItem(int ID, string Director, int Minutes, int Movies) : IGridItem;
...
public record AlbumGridItem(int ID, string Artist, string Title, int Minutes, int Times) : IGridItem;
...
public record ClassicalGridItem(int ID, string Composser, string Title, DateTime? LastDate) : IGridItem;
...
public record PersonGridItem(int ID, string FirstName, string LastName, string Nickname, string Birthday, string Tags) : IGridItem;
public record BirthdayGridItem(int ID, string FirstName, string LastName, string Birthday, int Age) : IGridItem;
