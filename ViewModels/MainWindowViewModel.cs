...
public class MainWindowViewModel(IDatasource datasource) : ViewModelBase
{
    ...
    public ClassicalViewModel ClassicalViewModel { get; } = new ClassicalViewModel(datasource, new ClassicalExternal());
    ...
    public YearlyTrendsSettingsViewModel YearlyTrendsSettingsViewModel { get; } = new YearlyTrendsSettingsViewModel();
}
